...
const queueName = process.env.QUEUE || 'Nano'
const exchangeName = process.env.EXCHANGE || 'my-topic'
const routingPattern = process.env.ROUTING_PATTERN || 'backoffice.users.1.#' /** Los patornes estan conformados por puntos la # remplaza cualquier palabra que venga despues. */
